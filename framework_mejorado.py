...
def main():
    ...
    features = ['age', 'bmi', 'HbA1c_level', 'blood_glucose_level', 'hypertension', 
                'heart_disease', 'gender_Male', 'smoking_history_former']
    ...
    # Retornar el modelo y los datos para posibles análisis adicionales
    return rf, df_balanced, features, X_train, y_train, X_val, y_val, X_test, y_test
